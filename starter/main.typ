...
#show: resume.with(
  ...
  summary: [
    Backend-focused full-stack and platform engineer with five years’ experience building cybersecurity products across AI security, cloud security, and third-party risk. Turns ambiguity into scalable production systems and reusable foundations, with end-to-end ownership and strong production judgment.
  ],
  skills: (
